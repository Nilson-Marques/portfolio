...
export const projects: Project[] = [
  {
    title: "Geriatric Scale Web App",
    description:
      "Healthcare web app helping clinicians assess geriatric patients using standardised clinical scales. Built end-to-end — owning both frontend and backend architecture. Integrated continuous feedback from medical professionals into iterative UI/UX improvements.",
    tags: ["React", "Next.js", "Node.js", "WCAG", "GDPR", "Healthcare"],
    status: "ongoing",
    github: "https://github.com/Nilson-Marques",
    highlight: true,
    domain: "Healthcare · Regulated domain",
  },
  {
